 ...
 * Flow: 전체 chatHistory → Cohere Phase 2 → Brief 저장 → 상태 갱신 → 알림
 */
@Service
...
public class AnalysisService {
    ...
    public CompletableFuture<Void> analyzeAsync(UUID consultationId) {
        ...
        try {
            ...
            // 2. Cohere Phase 2 호출 — 의뢰서 생성
            AiCallResult<BriefParsedResponse> result = cohereService.generateBrief(consultation);
