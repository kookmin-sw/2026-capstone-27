// Figma Node: 1:1157 - Case Analysis (390x1662)
// Source: get_design_context from fileKey 6eFZg6uOGTZiiNZTA8YyGF

const imgGroup = "https://www.figma.com/api/mcp/asset/b1ad298d-055f-4306-82c5-1421a4936442";
const imgGroup1 = "https://www.figma.com/api/mcp/asset/ec9130df-9165-49af-806c-4078dbfc4f85";
const imgGroup2 = "https://www.figma.com/api/mcp/asset/b26e50ee-2374-4a32-aed6-e7e49303f78e";
const imgGroup3 = "https://www.figma.com/api/mcp/asset/c5abf0e0-32d7-4474-b3bf-6430cf65c3b9";
const imgGroup4 = "https://www.figma.com/api/mcp/asset/9497908b-fbe8-41ec-ae12-844d9ed6fa03";
const imgGroup5 = "https://www.figma.com/api/mcp/asset/a5972d78-b8c3-481e-b98a-df90c9ee9a04";
const imgGroup6 = "https://www.figma.com/api/mcp/asset/d29cd4d5-8c62-4236-8ed0-9df5f52c69b7";
const imgLine = "https://www.figma.com/api/mcp/asset/327bbd33-5cec-43fe-bfd2-96d3a59d9c2c";
const imgGroup7 = "https://www.figma.com/api/mcp/asset/be946c67-4f5b-43c3-9a87-d80497a5f40b";
const imgGroup8 = "https://www.figma.com/api/mcp/asset/4e537574-0c79-434b-91bf-ca2b411d340d";
const imgGroup9 = "https://www.figma.com/api/mcp/asset/2fd758af-9157-4233-a81d-805f86ddfeb5";
const imgGroup10 = "https://www.figma.com/api/mcp/asset/a939c82e-84f3-4a6a-a0c3-46324b7767bd";
const imgGroup11 = "https://www.figma.com/api/mcp/asset/3db9133f-5720-4841-9da5-103d7ab4ea43";
const imgGroup12 = "https://www.figma.com/api/mcp/asset/66601344-40f0-4090-b49b-9c489b40065e";
const imgGroup13 = "https://www.figma.com/api/mcp/asset/33830102-3fed-4b2e-9c71-a8aaacc04b73";
const imgGroup14 = "https://www.figma.com/api/mcp/asset/98fee681-6464-49e2-8ff0-6fe17349ffe2";
const imgGroup15 = "https://www.figma.com/api/mcp/asset/55b322e9-1dfb-495d-8078-6bcf8b3eee51";
const imgGroup16 = "https://www.figma.com/api/mcp/asset/745d253d-7cbd-4f72-8a40-8e65b0c46148";
const imgGroup17 = "https://www.figma.com/api/mcp/asset/285ee82f-9aca-40ac-9e26-51051e5778f1";
const imgGroup18 = "https://www.figma.com/api/mcp/asset/058131ca-7253-4e45-b355-5bac17e92a47";
const imgGroup19 = "https://www.figma.com/api/mcp/asset/893f3f8e-417b-4a11-9634-41dd21dd5f8b";
const imgGroup20 = "https://www.figma.com/api/mcp/asset/3ff33da0-3e13-401f-aae4-ccf2c5125676";
const imgGroup21 = "https://www.figma.com/api/mcp/asset/baadc9b6-0548-4a59-b63b-db5c50f0d87c";
const imgGroup22 = "https://www.figma.com/api/mcp/asset/6b5d300c-eb9e-4b03-9d53-4c9b3d91ab11";
const imgGroup23 = "https://www.figma.com/api/mcp/asset/14176682-ad72-431a-9811-b33e4d0cfcf3";
const imgGroup24 = "https://www.figma.com/api/mcp/asset/b66205d7-0e6d-4d17-a08d-06fff4f8a7c0";
const imgGroup25 = "https://www.figma.com/api/mcp/asset/1111abb8-e11c-4b5e-ae77-9a2b3c9fb05f";
const imgGroup26 = "https://www.figma.com/api/mcp/asset/b323a692-c007-4064-a6e6-e76e98009620";
const imgGroup27 = "https://www.figma.com/api/mcp/asset/82786936-1468-4411-a195-5366ce0b202a";
const imgGroup28 = "https://www.figma.com/api/mcp/asset/f00e9bb9-5214-4edf-9d17-b514f8a68707";
const imgGroup29 = "https://www.figma.com/api/mcp/asset/e8f9224f-28c7-4c15-8d68-fcf1b0339900";
const imgGroup30 = "https://www.figma.com/api/mcp/asset/2dfb105c-c2eb-4d81-9224-4da56608e406";
const imgLine1 = "https://www.figma.com/api/mcp/asset/5df00b4b-c536-40b9-8e08-cc4a8feb8b03";
const imgGroup31 = "https://www.figma.com/api/mcp/asset/70d42299-b23b-47ce-bae5-34d9cc6e81f7";
const imgGroup32 = "https://www.figma.com/api/mcp/asset/07a6196f-5d8a-472f-9a0d-9e26f4cebb45";
const imgGroup33 = "https://www.figma.com/api/mcp/asset/57f379bc-8cbd-4503-b35b-17b401270eda";
const imgGroup34 = "https://www.figma.com/api/mcp/asset/951cb1ca-e4d9-473f-8e07-5d51ed732627";
const imgGroup35 = "https://www.figma.com/api/mcp/asset/9fb9537a-a53a-4566-bb3c-aeac39f69a70";
const imgGroup36 = "https://www.figma.com/api/mcp/asset/3ee0a5c4-03fd-456c-b650-8afdff9de0f1";
const imgGroup37 = "https://www.figma.com/api/mcp/asset/9b6da992-9916-441d-aa0e-805c17c0f8eb";
const imgGroup38 = "https://www.figma.com/api/mcp/asset/8eb6a625-eacb-47e2-9a3f-6f51cb8a1d67";
const imgGroup39 = "https://www.figma.com/api/mcp/asset/38a46ca7-321f-4971-87a6-9c1569087ef3";
const imgGroup40 = "https://www.figma.com/api/mcp/asset/9a00b9f4-b408-4468-8b6a-52840c141ea3";
const imgGroup41 = "https://www.figma.com/api/mcp/asset/b37e8e25-0020-4e8d-b754-89461a365bdc";
const imgGroup42 = "https://www.figma.com/api/mcp/asset/0bcb2c06-e3ae-4d95-8853-59fa7886cbc1";
const imgGroup43 = "https://www.figma.com/api/mcp/asset/9c5bec93-ef88-4b79-a82c-50263ca3f6cf";
    ...
    <div className="bg-white relative shadow-[0px_3px_6px_0px_rgba(18,15,40,0.12)] size-full" data-node-id="1:1157" data-name="Case Analysis">
      ...
      <div className="absolute bg-[#f9fafb] border border-[#dde0e4] border-solid h-[200px] left-[24px] rounded-[12px] top-[1301px] w-[342px]" data-node-id="1:1219">
        ...
        <div className="absolute flex flex-wrap gap-2 left-[16px] top-[76px] w-[310px]">
          ...
          <span className="bg-[#d7f1fe] border border-[rgba(31,177,249,0.2)] rounded-[15px] px-3 py-1 text-[#1fb1f9] text-[12px] font-medium"># 과실상계</span>
          <span className="border border-[rgba(32,223,96,0.2)] rounded-[15px] px-3 py-1 text-[#15803d] text-[12px] font-medium"># 공작물하자</span>
          <span className="bg-[#f9fafb] border border-[#dde0e4] rounded-[15px] px-3 py-1 text-[#31383f] text-[12px] font-medium"># 카페사고</span>
          <span className="bg-[#f9fafb] border border-[#dde0e4] rounded-[15px] px-3 py-1 text-[#31383f] text-[12px] font-medium"># 물기방치</span>
        </div>
      </div>
      {/* 헤더 */}
